...
public class GradebookControllerTest {
    ...
    @Mock
    StudentAndGradeService serviceMock;
    ...
    public static void setup() {
        ...
        request.setParameter("firstName", "Frodo");
        request.setParameter("lastName", "Baggins");
        request.setParameter("emailAddress", "frodo.baggins@lotr.com");
    }
    ...
    public void getStudentsHttpRequest() throws Exception {
        student.setFirstname("Bilbo");
        student.setLastname("Baggins");
        student.setEmailAddress("bulbo.baggins@lotr.com");
    ...
    public void createStudentHttpRequest() throws Exception {
        student.setFirstname("Bilbo");
        student.setLastname("Baggins");
        student.setEmailAddress("bilbo.baggins@lotr.com");
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress("bilbo.baggins@lotr.com");
